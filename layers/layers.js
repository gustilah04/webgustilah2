...
var format_polygon_3 = new ol.format.GeoJSON();
var features_polygon_3 = format_polygon_3.readFeatures(json_polygon_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_polygon_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_polygon_3.addFeatures(features_polygon_3);
var lyr_polygon_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_polygon_3, 
                style: style_polygon_3,
                popuplayertitle: 'polygon',
                interactive: true,
                title: '<img src="styles/legend/polygon_3.png" /> polygon'
            });

lyr_GoogleHybrid_0.setVisible(true);lyr_ADMINISTRASIKECAMATAN_AR_50K_1.setVisible(true);lyr_titik_lokasi_2.setVisible(true);lyr_polygon_3.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_ADMINISTRASIKECAMATAN_AR_50K_1,lyr_titik_lokasi_2,lyr_polygon_3];
...
lyr_titik_lokasi_2.set('fieldAliases', {'id': 'id', 'kecamatan': 'kecamatan', 'kelurahan': 'kelurahan', });
lyr_polygon_3.set('fieldAliases', {'id': 'id', });
...
lyr_titik_lokasi_2.set('fieldImages', {'id': '', 'kecamatan': '', 'kelurahan': '', });
lyr_polygon_3.set('fieldImages', {'id': '', });
...
lyr_titik_lokasi_2.set('fieldLabels', {'id': 'no label', 'kecamatan': 'no label', 'kelurahan': 'no label', });
lyr_polygon_3.set('fieldLabels', {'id': 'no label', });
lyr_polygon_3.on('precompose', function(evt) {
