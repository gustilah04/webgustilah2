...
var format_titik_lokasi_3 = new ol.format.GeoJSON();
var features_titik_lokasi_3 = format_titik_lokasi_3.readFeatures(json_titik_lokasi_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_titik_lokasi_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_titik_lokasi_3.addFeatures(features_titik_lokasi_3);
var lyr_titik_lokasi_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_titik_lokasi_3, 
                style: style_titik_lokasi_3,
                popuplayertitle: 'titik_lokasi',
                interactive: true,
                title: '<img src="styles/legend/titik_lokasi_3.png" /> titik_lokasi'
            });

lyr_GoogleHybrid_0.setVisible(true);lyr_ADMINISTRASIKECAMATAN_AR_50K_1.setVisible(true);lyr_polygon_2.setVisible(true);lyr_titik_lokasi_3.setVisible(true);
var layersList = [lyr_GoogleHybrid_0,lyr_ADMINISTRASIKECAMATAN_AR_50K_1,lyr_polygon_2,lyr_titik_lokasi_3];
...
lyr_polygon_2.set('fieldAliases', {'id': 'id', });
lyr_titik_lokasi_3.set('fieldAliases', {'id': 'id', 'kecamatan': 'kecamatan', 'kelurahan': 'kelurahan', });
...
lyr_polygon_2.set('fieldImages', {'id': '', });
lyr_titik_lokasi_3.set('fieldImages', {'id': 'TextEdit', 'kecamatan': 'TextEdit', 'kelurahan': 'TextEdit', });
...
lyr_polygon_2.set('fieldLabels', {'id': 'no label', });
lyr_titik_lokasi_3.set('fieldLabels', {'id': 'no label', 'kecamatan': 'no label', 'kelurahan': 'no label', });
lyr_titik_lokasi_3.on('precompose', function(evt) {
